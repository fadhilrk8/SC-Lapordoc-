...
#         self.root = root
#         self.root.title("Program Pemilihan Dokter")
...
#         # Widget Tkinter
#         self.title_label = tk.Label(root, text="LAPORDOC!", font=("Helvetica", 16, "bold"))
#         self.title_label.grid(row=0, column=0, columnspan=2, pady=10)

#         self.specialization_label = tk.Label(root, text="Pilih Spesialisasi Dokter:")
#         self.specialization_label.grid(row=1, column=0, pady=10)
...
#         self.specialization_menu.grid(row=1, column=1, pady=10)

#         self.select_button = tk.Button(root, text="Pilih Dokter", command=self.show_doctor_info, bg="#4CAF50", fg="white", font=("Helvetica", 12))
#         self.select_button.grid(row=2, column=0, columnspan=2, pady=10)

#         self.doctor_listbox = tk.Listbox(root, selectmode=tk.SINGLE, bg="#E0F7FA", fg="black")
#         self.doctor_listbox.grid(row=3, column=0, columnspan=2, pady=10)

#         self.doctor_info_frame = tk.Frame(root, bg="#B2EBF2", pady=20)
#         self.doctor_info_label = tk.Label(self.doctor_info_frame, text="", bg="#B2EBF2")
#         self.doctor_info_label.pack()
...
#     root.configure(bg="#E0F7FA")  # Ganti warna sesuai keinginan Anda
#     root.mainloop()
